                    ...
                    {popularUsers?.map((user) => (
                        <div key={user._id}>
                            {user.userRole === 'freelancer' && user._id !== userId && (
                                ...
                                >
                                    {/* User Profile Image */}
                                    <div className="relative w-16 h-16 ml-5 rounded-full overflow-hidden border-2 border-gray-300 hover:border-blue-500 transition-colors duration-200">
                                        <img
                                    ...
                                    {hoveredUser && hoveredUser._id === user._id && (
                                        <div className="absolute left-full top-2/3 transform -translate-y-1/2 ml-2 p-4 bg-white border border-gray-200 rounded-lg shadow-lg z-50 w-64 md:w-80 whitespace-normal transition-opacity duration-300 opacity-100">
