...
const ServiceCard = ({ gig }) => {
    ...
    return (
        <div className="flex-shrink-0 w-70 rounded-xl overflow-hidden shadow-md bg-white hover:shadow-lg transition duration-200">
            ...
            <div className="p-4">
                ...
                <div className="flex items-center mb-3">
                    ...
                    <span className="text-gray-800 font-bold mr-1">{rating}</span>
